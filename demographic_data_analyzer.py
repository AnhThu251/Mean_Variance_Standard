...
df = pd.read_csv(r'C:\Users\Thu\Python_FreeCodeCamp\Project\adult.data.csv')
print(df.head())
print(df.loc[df["education"] == "Bachelors"].size)
...
def calculate_demographic_data(print_data=True):
    ...
    degree = df.loc[df["education"] == "Bachelors"].size
    percentage_bachelors = round(degree / df.size * 100,1)
